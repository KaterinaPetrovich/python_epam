...
def add(apps, schema_editor):
    ...
    teacher = Teacher.objects.create(first_name="Petr", last_name="Petrov")
    student = Student.objects.create(first_name="Michail", last_name="Orlov")
    hw = Homework.objects.create(text="qwerty", deadline=7, author=teacher)
    hr = HomeworkResult.objects.create(solution="asdfg", author=student, task=hw)
